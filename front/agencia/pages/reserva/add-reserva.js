...
const AddReserva = () => {
  const [newReserva, setNewReserva] = useState({ IdDestino: "", Pagamento: "", StatusPedido: "", PrecoTotal: "", QtdReservada: "", IdCliente: ""});
      ...
      <table style={{ marginLeft: "20px" }}>
        <tbody>
          <tr>
            ...
            <td>
              <input
                type="text" name="IdDestino" value={newReserva.IdDestino} onChange={handleInputChange} class="form-control form-control-lg"/>
            </td>
          </tr>   
          <tr>
            <td>
